...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Issue.cleaner_id'
        db.alter_column('scru_issue', 'cleaner_id_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Issue.description'
        db.alter_column('scru_issue', 'description', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'Issue.closer_id'
        db.alter_column('scru_issue', 'closer_id_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Issue.cleaner_id'
        db.alter_column('scru_issue', 'cleaner_id_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))

        # Changing field 'Issue.description'
        db.alter_column('scru_issue', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=500))

        # Changing field 'Issue.closer_id'
        db.alter_column('scru_issue', 'closer_id_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))
    ...
    models = {
        ...
        'scru.issue': {
            ...
            'cleaner_id': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'issue_cleaner'", 'null': 'True', 'blank': 'True', 'to': "orm['auth.User']"}),
            'closer_id': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'issue_closer'", 'null': 'True', 'blank': 'True', 'to': "orm['auth.User']"}),
