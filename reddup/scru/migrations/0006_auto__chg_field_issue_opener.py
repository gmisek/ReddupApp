...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Issue.opener'
        db.alter_column('scru_issue', 'opener_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Issue.opener'
        db.alter_column('scru_issue', 'opener_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))
    ...
    models = {
        ...
        'scru.issue': {
            ...
            'opener': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'issue_opener'", 'null': 'True', 'blank': 'True', 'to': "orm['auth.User']"}),
